...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.saldosimple.com/articulos/${post.categoria?.slug}/${post.slug}`,
    },
    openGraph: {
      title: post.metaTitle || post.title,
      description: post.metaDescription || post.excerpt,
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 3,
        name: post.categoria?.title,
        item: `https://www.saldosimple.com/articulos/${post.categoria?.slug}`,
      },
      {
        "@type": "ListItem",
        position: 4,
        name: post.title,
        item: `https://www.saldosimple.com/articulos/${post.categoria?.slug}/${post.slug}`,
      },
    ],
  };
