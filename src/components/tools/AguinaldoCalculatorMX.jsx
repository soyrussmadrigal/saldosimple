...
const currencyOptions = [
  { code: "MXN", label: "Pesos Mexicanos", locale: "es-MX", symbol: "$" },
  { code: "USD", label: "Dólares", locale: "en-US", symbol: "$" },
];

export default function AguinaldoCalculatorMX() {
  ...
  const handleCalculate = () => {
    ...
    const result = dailySalary * 15 * (normalizedDays / 365); // Aguinaldo proporcional en México
    setAguinaldo(result);
  };

  const maxAguinaldo = salary; // Escala del odómetro
